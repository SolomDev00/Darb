...
const buttonVariants = cva(
  "flex items-center justify-center rounded-md font-base text-white duration-500 dark:text-black disabled:bg-indigo-400 disabled:hover:bg-indigo-400 disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
        default:
          "bg-indigo-900 dark:bg-indigo-900 dark:text-white dark:hover:bg-indigo-700",
        danger:
        ...
        outline:
          "border border-indigo-400 hover:text-white bg-transparent text-black hover:border-transparent hover:bg-indigo-900 dark:text-gray-700 dark:hover:text-white",
        noneborder:
          "hover:text-white bg-transparent text-black hover:bg-indigo-900 dark:text-gray-700 dark:hover:text-white",
      },
      size: {
        default: "p-3",
